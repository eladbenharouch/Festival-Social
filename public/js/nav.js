...
function renderNav(navElement, user, currentPage)
{
  ...
  navElement.innerHTML = `
    ...
    <li>
      <a href="/groups.html" class="${currentPage === 'groups' ? 'active' : ''}">
        Groups
      </a>
    </li>
    ...
    <li>
      <a href="/weather.html" class="${currentPage === 'weather' ? 'active' : ''}">
        Weather
      </a>
    </li>

    <li>
      <a href="/stats.html" class="${currentPage === 'stats' ? 'active' : ''}">
        Statistics
      </a>
    </li>
      ...
      <a href="/profile.html" class="profile-nav-link" title="My Profile">
        ${
          user.avatarUrl
            ...
            `
            : `
              <span class="nav-avatar nav-avatar-placeholder">
